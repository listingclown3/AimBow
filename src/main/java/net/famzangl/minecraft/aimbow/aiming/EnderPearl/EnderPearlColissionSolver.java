...
/**
 * Collision solver for Ender Pearl trajectories.
 * 
 * Uses the same collision detection as snowballs/eggs but dedicated for Ender Pearls.
 */
public class EnderPearlColissionSolver extends ColissionSolver {

	public EnderPearlColissionSolver(Minecraft mc, EntityLivingBase renderViewEntity) {
