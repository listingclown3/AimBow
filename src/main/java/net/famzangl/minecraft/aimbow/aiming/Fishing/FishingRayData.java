...
import static net.famzangl.minecraft.aimbow.aiming.Fishing.FishingColissionSolver.fishVelocity;

public class FishingRayData extends RayData {

	private static final boolean USE_RANDOM = false;
	public static float fishGravity = 0.025f;
	@Override
